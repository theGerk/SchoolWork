...
The graph minor theorem answers this question, at least in part. It states that any countable set $\mathcal G$ of finite graphs, contains a finite subset $\mathcal H\subset\mathcal G$ such that for all $G\in\mathcal G$ there is some $H\in\mathcal H$ such that $G$ contains a subset that is contactable to $H$. %TODO cite https://arxiv.org/pdf/1608.04066.pdf
